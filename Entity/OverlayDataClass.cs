...
public class OverlayDataClass
{
	...
	public OverlayDataClass(string charaName, string materialName, string color, SKBitmap overlayBmp, int selectedItemCount, bool isSelected)
	{
		CharaName = charaName;
	...
	public OverlayDataClass(OverlayDataClass other)
		: this(other.CharaName, other.MaterialName, other.Color, other.OverlayBmp, other.SelectedItemCount, other.IsSelected) { }
}
